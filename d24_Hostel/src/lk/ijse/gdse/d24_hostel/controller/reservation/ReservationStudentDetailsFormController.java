...
import lk.ijse.gdse.d24_hostel.view.tm.ReservationStudentDetailTm;
...
public class ReservationStudentDetailsFormController {
    ...
    private JFXButton getBtn(ReservationDTO reservationDTO) {
        ...
        btn.setStyle("-fx-max-width: 80px; -fx-background-color: #273c75; -fx-background-radius: 10; -fx-text-fill: #ffffff; -fx-font-weight: bold;");
    ...
    private void updateReservation(ReservationDTO reservationDTO) {
        ...
        try {
            URL resource = this.getClass().getResource("/lk/ijse/gdse/d24_hostel/resources/view/reservation/ReservationStudentDetailUpdateForm.fxml");
