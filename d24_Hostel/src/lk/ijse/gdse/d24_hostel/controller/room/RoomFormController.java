package lk.ijse.gdse.d24_hostel.controller.room;
...
import lk.ijse.gdse.d24_hostel.view.tm.RoomTm;
...
public class RoomFormController {
    ...
    private void deleteRoom(RoomDTO roomDTO) {
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            new Alert(Alert.AlertType.CONFIRMATION, "Room deleted successfully !", ButtonType.OK).show();
            clear();
    ...
    public void btnAddUpdateOnAction(ActionEvent actionEvent) {
        ...
        if (txtRoomId.getText().isEmpty() || !txtRoomId.getText().matches("^(RM-)([0-9]{4,}$)")) {
            ...
            new Alert(Alert.AlertType.ERROR, "Please input Qty", ButtonType.OK).show();
            ...
            if (roomService.updateRoom(new RoomDTO(txtRoomId.getText(), cmbRoomType.getValue().toString(), txtKeyMoney.getText(), Integer.parseInt(txtQty.getText()), Integer.parseInt(txtQty.getText()))) == null) {
